...
urlpatterns = [
    ...
    path("operations-full/", views.home_2, name="home_2"),
    ...
    path("query-results-operations-get-data-dashboard-all/", views.query_results_operations_get_data_dashboard_all, name="query_results_operations_get_data_dashboard_all"),
