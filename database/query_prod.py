...
from config_auth import TABLE_NAME_OPERATIONS, TABLE_NAME_ESTRATEGIAS, TABLE_RANK_OPERATIONS_M5, TABLE_NAME_OPERATIONS_ALL
...
# -----------------------------------------------
def query_database_prod_estrategia_all(string_query):
    try:
        conn = conn_db_producao()
        cursor = None
        dict_results = dict()
