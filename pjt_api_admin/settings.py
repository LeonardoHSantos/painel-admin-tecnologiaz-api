...
ALLOWED_HOSTS = [f"http://{config_auth.IP_SERVER}", f"{config_auth.IP_SERVER}", "http://127.0.0.1", "127.0.0.1", "localhost"]
CSRF_TRUSTED_ORIGINS = [f'http://{config_auth.IP_SERVER}', 'http://127.0.0.1']
